...
class PostResourceTest {
    ...
    public void listPostUserNotFoundTest() {
        ...
        .when()
            .get()
        .then()
            .statusCode(404).body(Matchers.is("Inexistent userId"));
    }

    @Test
    @DisplayName("should retirn 400 when followerId header is not present")
    ...
    @Test
    @DisplayName("should return 400 when follower doesn't not exist")
